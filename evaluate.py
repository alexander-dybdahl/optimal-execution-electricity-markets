...
def main():
    ...
    parser.add_argument("--plot_individual_trajectories", type=str2bool, nargs='?', const=True, default=eval_cfg["plot_individual_trajectories"], help="Plot individual trajectories")
    parser.add_argument("--n_traj", type=int, default=eval_cfg["n_traj"], help="Number of individual trajectories to plot")
    ...
    parser.add_argument("--plot_losses", type=str2bool, nargs='?', const=True, default=eval_cfg["plot_losses"], help="Plot training losses from CSV file")
    parser.add_argument("--plot_learned_vs_analytical", type=str2bool, nargs='?', const=True, default=eval_cfg["plot_learned_vs_analytical"], help="Plot learned vs analytical Q and Y comparison across all dimensions")
    parser.add_argument("--agents", type=str, nargs='*', default=eval_cfg["agents"], help="List of agents to evaluate. Available: Analytical, NN, TWAP, Hybrid, Immediate, StartEnd, KTimes_5, KTimes_10")
    ...
    parser.add_argument("--max_batch_size", type=int, default=eval_cfg["max_batch_size"], help="Maximum batch size for simulation (if None, uses training batch_size_per_rank)")
