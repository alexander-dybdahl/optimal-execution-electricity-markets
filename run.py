...
def main():
    ...
    parser.add_argument("--rescale_y0", type=str2bool, nargs='?', const=True, default=run_cfg["rescale_y0"], help="Rescale input in y0_net forward by y0")
    ...
    parser.add_argument("--affine", type=str2bool, nargs='?', const=True, default=run_cfg["affine"], help="Use affine transformation in batch normalization")
    parser.add_argument("--strong_grad_output", type=str2bool, nargs='?', const=True, default=run_cfg["strong_grad_output"], help="Use strong gradient output in initial network")
    parser.add_argument("--scale_output", type=float, default=run_cfg["scale_output"], help="How much to scale output in initial network")
    ...
    parser.add_argument("--adaptive_loss", type=str2bool, nargs='?', const=True, default=run_cfg["adaptive_loss"], help="Use adaptive loss function")
